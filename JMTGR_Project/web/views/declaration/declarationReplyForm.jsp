...
<body>
<h1 align="center"><%= DeNo  %> 번 글 댓글 달기 페이지 </h1>
<%@ include file="../common/header.jsp" %>
<%@ include file="../common/sidebar.jsp" %>

<hr>
<form action="/jmtgr/dreply" method="post"  >
<table align="center" width="500" border="1" cellspacing="0" cellpadding="5">
<input type="hidden" name="dnum" value="<%= DeNo %>">
...
<input type="button" value="목록보기" onclick="javascript:location.href='/jmtgr/dlist?page=<%= currentPage %>'">목록
</th></tr>
</table>
</form>
</body>
