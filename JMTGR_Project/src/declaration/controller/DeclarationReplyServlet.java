...
/**
 * Servlet implementation class DeclarationAnswerInsertServlet
 */
@WebServlet("/dreply.en")
public class DeclarationReplyServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DeclarationReplyServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int result = new DeclarationService().insertReply(rpy);
