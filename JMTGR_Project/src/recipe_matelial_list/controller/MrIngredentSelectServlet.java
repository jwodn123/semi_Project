...
/**
 * Servlet implementation class MrIngredentSelectServlet
 */
@WebServlet("/mingrelist")
public class MrIngredentSelectServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MrIngredentSelectServlet() {
        super();
