...
/**
 * Servlet implementation class MrIngredentSearchServlet
 */
@WebServlet("/mingresearch")
public class MrIngredentSearchServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MrIngredentSearchServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(list.size() > 0 ) {
			view = request.getRequestDispatcher("views/material_list/mrboardMaterialList.jsp");
