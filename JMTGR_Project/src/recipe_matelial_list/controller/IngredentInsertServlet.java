...
/**
 * Servlet implementation class IngredentInsertServlet
 */
@WebServlet("/insertingre")
public class IngredentInsertServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public IngredentInsertServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int result = new MatrialListService().insertMatrialList(mlist);
		if(result > 0) {
