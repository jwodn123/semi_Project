...
/**
 * Servlet implementation class packageMrInsertServlet
 */
@WebServlet("/pmrinsert")
public class packageMrInsertServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public packageMrInsertServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		packages.setMrBoardNo(Integer.parseInt(request.getParameter("MR_BOARD_NO")));
