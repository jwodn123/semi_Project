...
/**
 * Servlet implementation class packagesListDeleteServlet
 */
@WebServlet("/ilistdelete")
public class packagesListDeleteServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public packagesListDeleteServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int krboardno = Integer.parseInt(request.getParameter("krboardno"));
			int result = new PackagesService().Krdeletelist(userid, krboardno);
