...
/**
 * Servlet implementation class KrBoardListServlet
 */
@WebServlet("/listboard")
public class KRecipeListBoard extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public KRecipeListBoard() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<KRBoard> kblist = kservice.selectAllList(currentPage, limit);
		if (kblist.size() > 0) {
